...
export const ProfessionalClassic: React.FC<TemplateProps> = ({ data, font = 'serif' }) => {
    return (
        <div className={`w-full min-h-[297mm] bg-white p-10 text-gray-900 flex flex-col ${font === 'sans' ? 'font-sans' : 'font-serif'}`}>
            ...
            {data.certifications && data.certifications.length > 0 && (
                <section className="mb-6">
                    <h2 className="text-sm font-bold tracking-widest uppercase text-gray-900 mb-3">Certifications</h2>
