        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 mb-24">
          ...
          <div className="lg:col-span-4">
            <Link href="/" className="flex items-center gap-4 mb-10 group">
              ...
              <span className="text-3xl font-heading font-black text-gray-900 tracking-tight">
                CVRider
              </span>
            </Link>
            <p className="text-gray-500 font-medium leading-relaxed mb-10 max-w-sm">
              The next generation of career development tools.
              Precision-engineered, cloud-ready, and completely free for
              personal use.
            </p>
            <div className="flex gap-4">
              {[
                ...
                },
                {
                  ...
                  href: "https://linkedin.com/in/blessed-zhou",
                },
                {
                  icon: <Mail size={20} />,
          ...
          <div className="lg:col-span-8 grid grid-cols-2 sm:grid-cols-3 gap-12">
            <div>
              <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-900 mb-10">
                Evolution
              </h4>
        ...
        <div className="border-t border-gray-50 pt-12 flex flex-col md:flex-row items-center justify-between gap-10">
          <div className="flex items-center gap-6">
            <p className="text-xs font-bold text-gray-400">
              &copy; {new Date().getFullYear()} CVRider. Precision Engineering
              by{" "}
              <a
                href="https://blessy-io.vercel.app/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-900 hover:text-blue-600 transition-colors font-black"
              >
                Blessy
              </a>
              .
